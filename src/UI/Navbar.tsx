...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div className="flex">
        <aside
          className={`bg-(--Primary) border-r border-[#EFEFEF]/10 flex flex-col items-center overflow-y-auto hide-scrollbar pt-16 px-4 pb-6 gap-8 z-9999 
                      w-33.5 md:w-33.5 h-screen md:h-screen
