  ...
  return (
    <>
      ...
      <div className="min-h-screen p-4 mt-24 sm:px-6 md:px-8 lg:w-[907px] ml-0 lg:ml-[65px] md:pt-8 relative">
        ...
        <div className="btn_settings_container mt-6">
        ...
        {
          showSettings && (
            <div className="p-5 bg-[#060B1B] fixed z-[999] top-0 right-0 w-[90%] max-w-md h-[100dvh] shadow-[-8px_0_30px_0px_rgba(255,255,255,0.06)]">
              <button onClick={() => setShowSettings(false)} className="text-lg font-semibold mb-2 bg-[#7EE3FF] p-[8px] rounded-[8px]"><svg width="20" height="20" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M24.9999 24.9999L12.9999 12.9999M12.9999 12.9999L1 1M12.9999 12.9999L25 1M12.9999 12.9999L1 25" stroke="#060B1B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
              </button>
              <div className="flex flex-col  justify-between h-[88%] gap-4  mt-6">
